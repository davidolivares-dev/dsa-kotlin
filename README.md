...
- `GLOSSARY.md` — terminology used across `NOTES.md` files.
- Per topic, under `src/main/kotlin/<package>/`:
  - `NOTES.md` — the lesson: concept, invariants, complexity, when to use
    it, and a "Check Your Understanding" quiz bank.
  - `TASK.md` — the work order: what to implement, expected behavior/edge
    cases, and an example stub to copy in.
